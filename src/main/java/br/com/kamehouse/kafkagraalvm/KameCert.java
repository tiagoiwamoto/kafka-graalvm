...
public class KameCert<T> implements Deserializer<T> {
     ...
     */
    public KameCert(ObjectMapper objectMapper) {
     ...
     */
    public KameCert(@Nullable Class<? super T> targetType) {
     ...
     * @since 2.3
     */
    public KameCert(@Nullable TypeReference<? super T> targetType) {
        this(targetType, true);
    }
     ...
     * @since 2.3
     */
    public KameCert(@Nullable JavaType targetType) {
        this(targetType, true);
    }
     ...
     * @since 2.2
     */
    public KameCert(@Nullable Class<? super T> targetType, boolean useHeadersIfPresent) {
     ...
     * @since 2.3
     */
    public KameCert(TypeReference<? super T> targetType, boolean useHeadersIfPresent) {
        this(targetType, JacksonUtils.enhancedObjectMapper(), useHeadersIfPresent);
    }
     ...
     * @since 2.3
     */
    public KameCert(JavaType targetType, boolean useHeadersIfPresent) {
        this(targetType, JacksonUtils.enhancedObjectMapper(), useHeadersIfPresent);
    }
     ...
     */
    public KameCert(Class<? super T> targetType, ObjectMapper objectMapper) {
     ...
     * @param objectMapper the mapper. type if not.
     */
    public KameCert(TypeReference<? super T> targetType, ObjectMapper objectMapper) {
        this(targetType, objectMapper, true);
    }
     ...
     * @param objectMapper the mapper. type if not.
     */
    public KameCert(JavaType targetType, ObjectMapper objectMapper) {
        this(targetType, objectMapper, true);
    }
     ...
     * @since 2.2
     */
    public KameCert(@Nullable Class<? super T> targetType, ObjectMapper objectMapper,
     ...
     * @since 2.3
     */
    public KameCert(@Nullable JavaType targetType, ObjectMapper objectMapper,
                            boolean useHeadersIfPresent) {
    ...
    public synchronized void configure(Map<String, ?> configs, boolean isKey) {
        ...
        Assert.state(!this.setterCalled || !configsHasOurKeys(configs),
                "KameCert must be configured with property setters, or via configuration properties; not both");
        doSetUseTypeMapperForKey(isKey);
...
//    }
    ...
    private void setupTarget(Map<String, ?> configs, boolean isKey) {
        try {
            ...
            if (javaType != null) {
                initialize(javaType, Jackson2JavaTypeMapper.TypePrecedence.TYPE_ID.equals(this.typeMapper.getTypePrecedence()));
            }
        }
     ...
     * @since 2.6
     */
    public <X> KameCert<X> copyWithType(Class<? super X> newTargetType) {
     ...
     * @since 2.6
     */
    public <X> KameCert<X> copyWithType(TypeReference<? super X> newTargetType) {
     ...
     * @since 2.6
     */
    public <X> KameCert<X> copyWithType(JavaType newTargetType) {
        KameCert<X> result = new KameCert<>(newTargetType, this.objectMapper, this.useTypeHeaders);
     ...
     */
    public KameCert<T> dontRemoveTypeHeaders() {
     ...
     */
    public KameCert<T> ignoreTypeHeaders() {
     ...
     */
    public KameCert<T> typeMapper(Jackson2JavaTypeMapper mapper) {
     ...
     * @since 2,5
     */
    public synchronized KameCert<T> trustedPackages(String... packages) {
     ...
     * @since 2.5
     */
    public KameCert<T> typeFunction(BiFunction<byte[], Headers, JavaType> typeFunction) {
     ...
     * @since 2.5.3
     */
    public KameCert<T> typeResolver(JsonTypeResolver resolver) {
